...
assert(output and output.Schema == 3 and output.Outcome == "Victory", "telemetry output metadata is invalid")
...
assert(output.Samples[1].EnemySummary.Count == 1, "enemy summary was not recorded")
